...
[project.scripts]
claude-workspace = "claude_agent.claude_workspace:main"
copilot-workspace = "claude_agent.copilot_workspace:main"
opencode-workspace = "claude_agent.opencode_workspace:main"
workspace-bridge = "claude_agent.workspace_bridge:main"
otel-bridge = "claude_agent.otel_bridge:run_server"

[tool.hatch.build.targets.wheel]
packages = ["claude_agent"]
...
:PROPERTIES:
:LITERATE_ORG_BLOCK_KIND: atomic
:header-args: :tangle ./python/claude_agent/mcp_client.py :mkdirp yes
:END:
...
:header-args: :tangle ./python/claude_agent/workspace_bridge.py :mkdirp yes
:END:

...
- [[#observability][Observability]]
  - [[#tracer-factory-and-context-store][Tracer Factory and Context Store]]
    ...
    - [[#assignment-phoenix_endpoint][Assignment PHOENIX_ENDPOINT]]
    - [[#assignment-phoenix_health_url--phoenix_endpointrsplitv1traces-10--health][Assignment PHOENIX_HEALTH_URL = PHOENIX_ENDPOINT.rsplit("/v1/traces", 1)[0] + "/health"]]
    - [[#assignment-status_dir--tmpclaude-agent-status][Assignment STATUS_DIR = "/tmp/claude-agent-status"]]
    - [[#function-_phoenix_is_running][Function _phoenix_is_running]]
    - [[#function-_ensure_phoenix][Function _ensure_phoenix]]
  ...
  - [[#otel-relay-server][OTel Relay Server]]
    ...
    - [[#assignment-_span_kind_map][Assignment _SPAN_KIND_MAP]]
    - [[#assignment-_oi_kind_attr--openinferencespankind][Assignment _OI_KIND_ATTR = "openinference.span.kind"]]
    - [[#assignment-_oi_kind_defaults][Assignment _OI_KIND_DEFAULTS]]
    - [[#assignment-_meta_attr_keys--span-kind-oi-kind-input-output][Assignment _META_ATTR_KEYS = {"span-kind", "oi-kind", "input", "output"}]]
...
- [[#workspace-layer][Workspace Layer]]
  ...
  - [[#workspace-bridge][Workspace Bridge]]
    ...
    - [[#assignment-_oi_kind_attr--openinferencespankind-1][Assignment _OI_KIND_ATTR = "openinference.span.kind"]]
    ...
    - [[#function-_cli_session_property][Function _cli_session_property]]
    ...
    - [[#class-workspacebridgeprotocol][Class WorkspaceBridgeProtocol]]
  ...
  - [[#claude-workspace][Claude Workspace]]
    ...
    - [[#function-_find_workspace_bridge_path][Function _find_workspace_bridge_path]]
    - [[#function-_write_hooks_settings][Function _write_hooks_settings]]
  ...
  - [[#copilot-workspace][Copilot Workspace]]
    ...
    - [[#function-_inject_emacs_mcp_into_dotgithub][Function _inject_emacs_mcp_into_dotgithub]]
    - [[#function-_write_agents_md][Function _write_agents_md]]
  ...
  - [[#opencode-workspace][OpenCode Workspace]]
    ...
    - [[#function-_write_agents_md-1][Function _write_agents_md]]
...
- [[#tests][Tests]]
  ...
  - [[#test_workspace_bridge][test_workspace_bridge]]
    ...
    - [[#class-testworkspacebridgeprotocol][Class TestWorkspaceBridgeProtocol]]
...
#+end_src
*** Assignment PHOENIX_HEALTH_URL = PHOENIX_ENDPOINT.rsplit("/v1/traces", 1)[0] + "/health"
#+begin_src python
PHOENIX_HEALTH_URL = PHOENIX_ENDPOINT.rsplit("/v1/traces", 1)[0] + "/health"

#+end_src
*** Assignment STATUS_DIR = "/tmp/claude-agent-status"
#+begin_src python
STATUS_DIR = "/tmp/claude-agent-status"

#+end_src
*** Function _phoenix_is_running
#+begin_src python
# ======================================================================
# Phoenix auto-start
#
...
#+end_src
*** Assignment _OI_KIND_ATTR = "openinference.span.kind"
#+begin_src python
...
#+end_src
*** Assignment _META_ATTR_KEYS = {"span-kind", "oi-kind", "input", "output"}
#+begin_src python
...
#+end_src
*** Function _cli_session_property
#+begin_src python
...
#+end_src
*** Function _find_workspace_bridge_path
#+begin_src python
...
#+end_src
*** Function _write_hooks_settings
#+begin_src python
...
#+end_src
*** Function _inject_emacs_mcp_into_dotgithub
#+begin_src python
from __future__ import annotations
...
class TestHandleResponsePromptInsertion:
    ...
    def test_custom_id_written_after_prompt_insertion(self, tmp_path, monkeypatch):
        ...
        with patch.object(bridge, "_write_custom_id", wraps=bridge._write_custom_id) as mock_write:
            bridge._handle_response(

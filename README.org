...
Template defaults are loaded from =claude-org-templates.el= in the package directory.
To customize:

*Option 1: Edit the default file*

Edit =claude-org-templates.el= directly. Changes take effect after reloading:

#+BEGIN_SRC elisp :load no
(literate-elisp-load "claude-org.org")  ;; reloads and picks up the file
#+END_SRC
...
*Option 3: Override in init file*

Set the variable directly:

#+BEGIN_SRC elisp :load no
(setq claude-org-templates
      '(("Review" . "Please review this code")
        ("Backtrace" . claude-org-template--backtrace)))
#+END_SRC

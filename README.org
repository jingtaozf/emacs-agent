...
- [[#features][Features]]
  ...
  - [[#ref-docker-sandbox][Docker Sandbox Support]]
  ...
  - [[#ref-scheduled-execution][Scheduled AI Block Execution]]
    ...
    - [[#commands][Commands]]
  - [[#ref-timestamped-responses][Timestamped Response Sections]]
...
| =code-agent-org-permission-protect-org= | Protect .org files from direct edits |
...
The =code-agent-org= package provides a permission function to protect .org files:

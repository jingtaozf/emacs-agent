...
Use =C-c C-/= then =d= (or =M-x code-agent-org-insert-workspace=):
...
,#+PROPERTY: CLAUDE_HOST_PATH /Users/yourname/projects/myproject
...
| =CLAUDE_HOST_PATH= | Host machine path that is mounted in container |
...
:CLAUDE_HOST_PATH: /Users/me/projects/backend
...
(setq code-agent-org-default-system-prompts '("Your custom prompt"))
...
;; Note: Usually set via CLAUDE_HOST_PATH and CLAUDE_CONTAINER_PATH properties
#+END_SRC

...
(claude-agent-query prompt :callbacks cbs :timeout 30)

;; Better — bake it in until a second caller appears
(claude-agent-query prompt :callbacks cbs)
```

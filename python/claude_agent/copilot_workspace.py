...
def _write_agents_md(project_root: str, system_prompt: str) -> None:
    ...
    The existing content is preserved with a clear header/footer so
    session instructions are visually separate from permanent project
    guidance. On exit the file is restored.
    """

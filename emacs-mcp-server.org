...
The sibling =report_invocation= tool records skill/rule invocations for
observability and has no filesystem effect — it is not in scope here.
...
Seven test files cover this module under =tests/=:

...
TITLE is the heading hierarchy string, STORY-NAME is the session ancestor
heading text (or nil if no session-scope heading).
                ...
                (save-excursion
                  (while (org-up-heading-safe)
                    ...
                    (when (and (not story-name)
                      ...
                      (setq story-name
                            (substring-no-properties (org-get-heading t t t t))))))
                (cons (string-join (reverse headings) " > ")
                      story-name)))
          (error nil))))))

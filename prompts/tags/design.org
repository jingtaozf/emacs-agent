...
| Output | Write design to =docs/design-docs/YYYY-slug.org= |
...
- Research file at =docs/research/YYYY-slug.org= (Codebase Patterns, Relevant Files, External References)
- Reference these findings when making design decisions

*** Output → Used By Planning Phase
- Design doc at =docs/design-docs/YYYY-slug.org= (Goals, Non-Goals, Proposed Solution, Technical Design,
  Alternatives Considered, Test Plan, Open Questions)
- Planning phase will reference this to create atomic TODOs

** Writing the Design Doc

Write design sections directly to =docs/design-docs/YYYY-slug.org= using Read/Edit/Write tools:

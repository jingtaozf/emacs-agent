...
- Replan or add new TODOs (go back to Planning phase if needed)

*** Input ← From Previous Phases
- Spec section: Technical Design for implementation details
- Features section: TODO items to implement (work on first incomplete one)
- Research Output: Codebase Patterns to follow

*** Output
- Working code with tests
- Mark TODOs as DONE in Features section
...
4. Mark TODO as DONE using =(org-todo)= via =evalElisp=
...
You can use =C-c C-t= in Emacs or =(org-todo)= via =evalElisp=.

...
(when (boundp 'test-code-agent-project-root)
  (let ((root test-code-agent-project-root))
    ...
    (unless (featurep 'code-agent-jsonrpc)
      (literate-elisp-load (expand-file-name "code-agent-jsonrpc.org" root)))
    (unless (featurep 'code-agent-acp)
      (literate-elisp-load (expand-file-name "code-agent-acp.org" root)))
    (unless (featurep 'code-agent-acp-opencode)
      (literate-elisp-load (expand-file-name "code-agent-acp-opencode.org" root)))
    (unless (featurep 'code-agent-acp-gemini)
      (literate-elisp-load (expand-file-name "code-agent-acp-gemini.org" root)))
    (unless (featurep 'code-agent-acp-codex)
      (literate-elisp-load (expand-file-name "code-agent-acp-codex.org" root)))))

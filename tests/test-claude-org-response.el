;;; test-claude-org-response.el --- Tests for timestamped response sections -*- lexical-binding: t; -*-
...
;; Unit tests for timestamped response section functionality in claude-org.
...
"
   (re-search-forward "^\\*\\* Instruction 1")
   (let ((last-output-end (claude-org--find-last-ai-output-sibling)))
...
"
   (re-search-forward "^\\*\\* Instruction 1")
   (should-not (claude-org--find-last-ai-output-sibling))))
...
;;; test-claude-org-response.el ends here

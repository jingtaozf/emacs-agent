;;; test-claude-org-refine.el --- Tests for prompt refinement -*- lexical-binding: t; -*-
...
;; Tests for claude-org-refine-prompt and claude-agent-refine-prompt.
...
;; ═══════════════════════════════════════════════════
;; Tests: claude-org-refine-prompt (org-mode layer)
  ...
  (let ((refine-on-result nil)
    ...
    (cl-letf (((symbol-function 'claude-agent-refine-prompt)
      ...
      (with-temp-buffer
        ...
        ;; At this point the let* in claude-org-refine-prompt has exited.
...
(provide 'test-claude-org-refine)
;;; test-claude-org-refine.el ends here
